...
#
# Generated by export_simulation on Thu Dec 18 16:07:38 +0700 2025
#
################################################################################
...
'-reset_run' switch to the './img_rot_design.sh' script.

./img_rot_design.sh -reset_run
...
./img_rot_design.sh -noclean_files

For more information on the script, please type './img_rot_design.sh -help'.
