...
HD_PWD='D:/SingleDGH/ComputerEngineering/VivadoProject/img_rot_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log img_rot_design_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source img_rot_design_wrapper.tcl -notrace
