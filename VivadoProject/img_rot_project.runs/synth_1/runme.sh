...
HD_PWD='D:/SingleDGH/ComputerEngineering/VivadoProject/img_rot_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log img_rot_design_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source img_rot_design_wrapper.tcl
