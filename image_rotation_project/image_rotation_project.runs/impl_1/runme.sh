...
HD_PWD='D:/SingleDGH/ComputerEngineering/VivadoProject/image_rotation_project/image_rotation_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log image_rotation_design_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source image_rotation_design_wrapper.tcl -notrace
