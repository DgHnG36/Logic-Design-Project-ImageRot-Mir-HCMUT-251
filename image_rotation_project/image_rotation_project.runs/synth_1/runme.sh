...
HD_PWD='D:/SingleDGH/ComputerEngineering/VivadoProject/image_rotation_project/image_rotation_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log image_rotation_design_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source image_rotation_design_wrapper.tcl
