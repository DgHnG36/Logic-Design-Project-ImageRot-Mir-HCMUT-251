...
HD_PWD='D:/SingleDGH/ComputerEngineering/VivadoProject/image_rotation_project/image_rotation_project.runs/image_rotation_design_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log image_rotation_design_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source image_rotation_design_xbar_0.tcl
