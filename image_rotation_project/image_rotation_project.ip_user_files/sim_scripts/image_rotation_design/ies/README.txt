...
#
# Generated by export_simulation on Sun Dec 14 16:07:17 +0700 2025
#
################################################################################
...
'-reset_run' switch to the './image_rotation_design.sh' script.

./image_rotation_design.sh -reset_run
...
./image_rotation_design.sh -noclean_files

For more information on the script, please type './image_rotation_design.sh -help'.
