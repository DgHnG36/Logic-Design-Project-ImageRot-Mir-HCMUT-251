...
HD_PWD='D:/SingleDGH/ComputerEngineering/img_rot_project/img_rot_project.runs/image_rotator_design_smartconnect_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log image_rotator_design_smartconnect_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source image_rotator_design_smartconnect_0_0.tcl
