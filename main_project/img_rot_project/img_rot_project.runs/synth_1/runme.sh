...
HD_PWD='D:/SingleDGH/ComputerEngineering/LogicDesign/img_rot_project/img_rot_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log image_rotator_design_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source image_rotator_design_wrapper.tcl
