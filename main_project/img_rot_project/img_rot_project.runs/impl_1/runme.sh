...
HD_PWD='D:/SingleDGH/ComputerEngineering/LogicDesign/img_rot_project/img_rot_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log image_rotator_design_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source image_rotator_design_wrapper.tcl -notrace
