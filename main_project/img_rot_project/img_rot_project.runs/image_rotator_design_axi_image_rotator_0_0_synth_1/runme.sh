...
EAStep vivado -log image_rotator_design_axi_image_rotator_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source image_rotator_design_axi_image_rotator_0_0.tcl
