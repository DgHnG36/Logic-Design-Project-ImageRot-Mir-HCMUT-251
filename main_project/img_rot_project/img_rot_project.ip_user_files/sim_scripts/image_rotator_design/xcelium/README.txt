...
#
# Generated by export_simulation on Fri Dec 19 19:05:53 +0700 2025
#
################################################################################
...
'-reset_run' switch to the './image_rotator_design.sh' script.

./image_rotator_design.sh -reset_run
...
./image_rotator_design.sh -noclean_files

For more information on the script, please type './image_rotator_design.sh -help'.
